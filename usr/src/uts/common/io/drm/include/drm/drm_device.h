...
/* illumos: AGP support stubbed for Phase 1 */
struct drm_agp_head;
...
struct drm_device {
	...
	void			*dmat;	/* bus_dma_tag_t: illumos stub */
	void			*bst;	/* bus_space_tag_t: illumos stub */

	/* klist note: OpenBSD kqueue stub, not used on illumos */
	int			_note_pad;
