...
#define debugfs_create_atomic_t(a, b, c, d)	do {} while (0)
#define debugfs_remove(a)			do {} while (0)
...
#define debugfs_create_bool(a, b, c, d)		do {} while (0)

#define DEFINE_DEBUGFS_ATTRIBUTE(a, b, c, d)	/* stub */
