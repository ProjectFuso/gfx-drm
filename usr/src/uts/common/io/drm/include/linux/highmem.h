...
/*
 * illumos Phase 1: kmap/kunmap/kmap_atomic are stubs.
 * Full implementation requires HAT KPM (kernel page mapping).
 */
...
static inline void *
kmap_local_page(struct page *pg)
{
...
static inline void
memcpy_from_page(char *dst, struct page *page, size_t off, size_t len)
{
...
static inline void
memcpy_to_page(struct page *page, size_t off, const char *src, size_t len)
{
