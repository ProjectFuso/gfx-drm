...
/* illumos: OpenBSD ACPI headers removed; ACPI is stubbed for Phase 1 */
/* #include <dev/acpi/acpireg.h> — OpenBSD only */
/* #include <dev/acpi/acpivar.h> — OpenBSD only */
...
/* illumos: acpi_handle is an opaque void * (Phase 1 stub) */
...
/* illumos: ACPI_HANDLE returns NULL (Phase 1 stub) */
#define ACPI_HANDLE(x)	NULL
